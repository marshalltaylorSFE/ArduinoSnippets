...
//
//**********************************************************************//
CircularBuffer::CircularBuffer( uint8_t depthInput = CIRCULAR_BUFFER_MAX_LENGTH ) : topPointer(0), bytesUsed(0), bufferDepth(depthInput) 
{
	buffer[0] = 0;
}

int16_t CircularBuffer::read( uint8_t inputDepth )
{
...
void CircularBuffer::write( int16_t inputData )
{
